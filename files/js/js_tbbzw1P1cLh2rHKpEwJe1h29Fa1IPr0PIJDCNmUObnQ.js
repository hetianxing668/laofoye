    ...
    Tipsy.prototype = {
        show: function() {
            ...
            if (title && this.enabled) {
                ...
                // Declare scroll offset only for IE 8.
                ...
                switch (gravity.charAt(0)) {
                    case 'n':
                      tp = {top: pos.top + pos.height + this.options.offset + ieOffset, left: pos.left + pos.width / 2 - actualWidth / 2};
                      break;
                    case 's':
                      tp = {top: pos.top - actualHeight - this.options.offset + ieOffset, left: pos.left + pos.width / 2 - actualWidth / 2};
                      break;
                    case 'e':
                      tp = {top: (pos.top + pos.height / 2 - actualHeight / 2) + ieOffset, left: pos.left - actualWidth - this.options.offset};
                      break;
                    case 'w':
                      tp = {top: (pos.top + pos.height / 2 - actualHeight / 2) + ieOffset, left: pos.left + pos.width + this.options.offset};
                      break;
                }
